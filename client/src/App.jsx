...
import TournamentJoin from './pages/TournamentJoin.jsx';
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/tournaments/:id/pool-play" element={<TournamentPoolPlayAdmin />} />
      ...
      <Route path="/tournaments/join" element={<TournamentJoin />} />
